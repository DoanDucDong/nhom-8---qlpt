						...
						<div class="form-group-1 row text-center">
							...
							<div class="col search-left">
								<select class="selectpicker" data-live-search="true" id="selectcategory">
									<option>Nhỏ hơn 1km</option>
									<option>Từ 1km - 2km</option>
									<option>Từ 3km - 4km</option>
									<option>Từ 5km - 6km</option>
									<option>Từ 7km - 8km</option>
									<option>Từ 9km - 10km</option>
								</select>
							</div>
							...
							<div class="col search-left">
								<button class="btn btn-success" ><a href="#"></a>Tìm kiếm ngay</button>
							</div>
						</div>
